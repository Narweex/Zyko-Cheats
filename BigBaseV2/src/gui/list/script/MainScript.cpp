...
namespace zyko
{
	...
	void MainScript::script_init()
	{
		...
		g_UiManager->AddSubmenu<RegularSubmenu>("Vehicle", SubmenuVehicleAcrobatics, [=](RegularSubmenu* sub)
			{
				sub->AddOption<RegularOption>("Forward Flip", "Forward Flip", [=] {	features::acrobatics(Frontflip);	});
				sub->AddOption<RegularOption>("Forward Flip", "Forward Flip", [=] {	features::acrobatics(Backflip);	});

				sub->AddOption<RegularOption>("Left Flip", "Forward Flip", [=]
					{
						features::acrobatics(LeftFlip);
					});
				sub->AddOption<RegularOption>("Left Flip", "Forward Flip", [=]
					{
						features::acrobatics(RightFlip);
					});
				sub->AddOption<RegularOption>("Jump Up", "Jump Up", [=]
					{
						features::acrobatics(JumpUp);
					});
				sub->AddOption<RegularOption>("Launch Up", "Jump Up", [=]
					{
						features::acrobatics(LaunchUp);
					});
