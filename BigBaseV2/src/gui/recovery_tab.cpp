...
namespace big
{
	void recovery_tab::render_recovery_tab()
	{
				...
				features::basket_transaction(-1799524201, -788753717, 4,
					{
						{-1026265157, -1826424790, 0, 1, 1},
						{-1573825732, -1, 0, 1, 1},
						{-1818214114, -1573825732, bunker_money, 0, 1},
					});
		...
		ImGui::SliderInt(xorstr_("$"), &bunker_money, 1, 5000000);
		ImGui::PopItemWidth();
		...
		if (ImGui::Button(xorstr_("Set Rank")))
		{
			QUEUE_JOB_BEGIN_CLAUSE()
			{
				...
				AUDIO::PLAY_SOUND_FRONTEND(-1, xorstr_("CHALLENGE_UNLOCKED"), xorstr_("HUD_AWARDS"), 1);
			}	QUEUE_JOB_END_CLAUSE
		}
		...
		if (ImGui::Button(xorstr_("Set Char Creation Date")))
		{
			QUEUE_JOB_BEGIN_CLAUSE()
			{
				...
				STATS::STAT_SET_INT(RAGE_JOAAT("LEADERBOARD_PLAYING_TIME"), INT_MAX, TRUE);
				...
				STATS::STAT_SET_INT(RAGE_JOAAT("MP_PLAYING_TIME_NEW"), INT_MAX, TRUE);
				STATS::STAT_SET_INT(RAGE_JOAAT("MP_PLAYING_TIME"), INT_MAX, TRUE);
