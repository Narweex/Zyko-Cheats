...
#include "script.hpp"
#include <imgui.h>
#include "playerinfo_gui.h"
#include "gui/base_tab.h"


namespace big
{
	void playerinfo_gui::dx_init()
	{
	...
	void playerinfo_gui::dx_on_tick()
	{
		TRY_CLAUSE
		{
	...
	void playerinfo_gui::script_init()
	{
	}

	void playerinfo_gui::script_on_tick()
	{
		TRY_CLAUSE
		{
			if (info_gui.m_opened)
			{
	...
	void playerinfo_gui::script_func()
	{
		info_gui.script_init();
		while (true)
		{
			info_gui.script_on_tick();
