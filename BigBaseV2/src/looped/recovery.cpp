...
namespace zyko
{
	...
	void features::unlock_everything()
	{
	...
	void features::unlock_achievements()
	{
		for (int i = 1; i <= 77; i++)
			PLAYER::GIVE_ACHIEVEMENT_TO_PLAYER(i);
	}
	void features::max_creation_date()
	{
	...
	void features::eight_years_playtime()
	{
		for (int i = 0; i <= 115; i++) {
